...
import com.droidoxy.easymoneyrewards.adapters.TransactionPagerAdapter;
...
public class TransactionActivity extends ActivityBase {
    ...
    void initViews(){
        ...
        ViewPager pager = findViewById(R.id.transation);
        SlidingTabLayout tabs = findViewById(R.id.tabs);
        CharSequence Titles[] = {getResources().getString(R.string.home)};
        adapter = new TransactionPagerAdapter(getSupportFragmentManager(), Titles, Numboftabs);
        ...
        if(App.getInstance().get("APP_TABS_ENABLE",false)){
            ...
            adapter =  new TransactionPagerAdapter(getSupportFragmentManager(),Titles2,Numboftabs);
        ...
        // Navigation Drawer
        mDrawerLayout = findViewById(R.id.transaction_activity_DrawerLayout);
    }
    ...
    void initNavDrawer(){
        ...
        ImageButton redeem = (ImageButton)findViewById(R.id.nav_transactions);
        redeem.setBackgroundDrawable(getResources().getDrawable(R.drawable.transaction_active));

        ImageButton transaction = (ImageButton)findViewById(R.id.redeem);
