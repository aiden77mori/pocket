...
import com.droidoxy.easymoneyrewards.activities.TransactionActivity;
...
public class ReferFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ImageButton refer = (ImageButton)view.findViewById(R.id.refer);
        refer.setBackgroundDrawable(getResources().getDrawable(R.drawable.refer_active));

        ImageButton transaction = (ImageButton)view.findViewById(R.id.nav_transactions);
        transaction.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AppUtils.setAnimation(view);
                Intent transactions = new Intent(ctx, TransactionActivity.class);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AppUtils.setAnimation(view);
                Intent transactions = new Intent(ctx, MainActivity.class);
                startActivity(transactions);
            }
        });
        home.setBackgroundDrawable(getResources().getDrawable(R.drawable.home_normal));

        ImageButton redeem = (ImageButton)view.findViewById(R.id.redeem);
        redeem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AppUtils.setAnimation(view);
                Intent transactions = new Intent(ctx, RedeemActivity.class);
                startActivity(transactions);
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AppUtils.setAnimation(view);
                ((ReferActivity)getActivity()).onBackPressed();
            }
        });
    ...
    void finish(){
        ...
        if(close instanceof RedeemActivity){
//            RedeemActivity show = (RedeemActivity) close;
//            show.closeActivity();
        }
